declare module TcHmi.Controls.Beckhoff {
    class TcHmiDatagrid extends TcHmi.Controls.System.TcHmiControl {
         ...
         * @param column The index of the column to modify.
         */
        protected __modifySrcData(valueNew: any, row: number, column: number, rowElement?: HTMLElement, forceWrite?: boolean): {
            convertedValue: any;
            needSorting: boolean;
        } | null;
        /**
