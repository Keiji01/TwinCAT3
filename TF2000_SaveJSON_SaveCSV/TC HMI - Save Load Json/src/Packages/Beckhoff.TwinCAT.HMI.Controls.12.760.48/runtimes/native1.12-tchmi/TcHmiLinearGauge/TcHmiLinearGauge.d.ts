declare module TcHmi.Controls.Beckhoff {
    class TcHmiLinearGauge extends System.TcHmiControl {
        ...
        protected __userInput: TcHmiLinearGauge.UserInput | null;
        protected __storage: LocalStorage<{
            userInput: TcHmiLinearGauge.UserInput;
        }, {
            userInput: boolean;
        }> | undefined;
         ...
         */
        protected __processIgnoreInvalidValues(layout?: boolean): void;
        /**
         ...
         */
        protected __evaluateDataPrecedence(incoming: number): boolean;
        /**
         ...
         */
        getValueSpaceUnit(): "px" | "%" | undefined;
        /**
         * Processes the current value of attribute textfontsizeunit.
         */
