declare module TcHmi.Controls.System {
    ...
    class TcHmiUserControlHost extends TcHmiControl {
        ...
        protected __partialDefaultVirtualRights: Map<string, ControlAccessDescription>;
    ...
    module TcHmiUserControlHost {
        interface IScopedMarkupResultObject extends IResultObject {
            markup?: string;
        }
    }
}
