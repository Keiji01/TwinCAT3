declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiTreeView extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __filterStrategy: FilterInstance.Strategy | undefined;
        ...
        protected __visibilityChangedDestroyEvent: DestroyFunction | null;
        ...
        protected __asyncWorkData: TcHmiTreeView.IControlSpecificData;
        /**
        ...
        protected __getIndicesOfPathRecursive(children: any[], path: ObjectPath, pathIndices: number[], columnName: string): boolean;
        /**
         ...
         */
        protected __useSpinbox(columnDefinition: TcHmiTreeView.Column | TcHmiTreeView.SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, data: any, inputElement: HTMLInputElement, targetButton: HTMLElement): number | null;
        /**
         ...
         */
        protected __useDateTimePicker(columnDefinition: TcHmiTreeView.Column | TcHmiTreeView.SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, dataRow: number[], inputElement: HTMLInputElement, buttonElement: HTMLElement, cellElement: HTMLElement): void;
        /**
         ...
         */
        protected __getHierarchicalSchema(schema: JsonSchema | null | undefined, dataRow: number[] | undefined, columnDefinition: TcHmiTreeView.Column | TcHmiTreeView.SimpleColumn): string | undefined;
        /**
         ...
         */
        protected __useTimespanPicker(columnDefinition: TcHmiTreeView.Column | TcHmiTreeView.SimpleColumn, dataDefinitions: TcHmiDatagrid.DataDefinition | TcHmiDatagrid.DataDefinition[] | undefined, dataRow: number[], inputElement: HTMLInputElement, buttonElement: HTMLElement, cellElement: HTMLElement): void;
        /**
         ...
         */
        protected __modifyData(valueNew: any, row: number[], column: number, rowElement?: HTMLElement, forceWrite?: boolean, symbolWriteCallback?: (data: IErrorDetails | null) => void): {
            convertedValue: any;
            needSorting: boolean;
        } | null;
        /**
         ...
         */
        protected __generateSchemaByDataDefintions(value: any, columnDefinition?: TcHmiTreeView.Column | TcHmiTreeView.SimpleColumn): JsonSchema;
        /**
         ...
         */
        setFilterStrategy(valueNew: FilterInstance.Strategy | keyof typeof FilterInstance.Strategy | null): void;
        /**
         * Gets the value of FilterStrategy
         * @returns The current value of FilterStrategy
         */
        getFilterStrategy(): FilterInstance.Strategy | undefined;
        /**
    ...
    namespace TcHmiTreeView {
        ...
        type ColumnControl = 'TextBlock' | 'TextBox' | 'CheckBox' | 'ComboBox' | 'Image' | 'PasswordInput' | 'NumericInput' | 'SpinboxInput' | 'DateTimeInput' | 'TimespanInput' | 'Button' | 'ToggleButton' | 'ToggleSwitch' | 'RadioButton' | 'HTMLElement' | 'AutoDetectControl';
