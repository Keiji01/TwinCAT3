declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiRadioButton extends TcHmi.Controls.System.TcHmiControl {
         ...
         */
        setRadioStateBackgroundColor(valueNew: SolidColor | null): void;
        /**
         ...
         */
        protected __onResolverForRadioStateBackgroundColorWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<SolidColor>): void;
        /**
         * Returns the current value of radioStateBackgroundColor.
         * @returns The current value of radioStateBackgroundColor.
         */
        getRadioStateBackgroundColor(): SolidColor | null | undefined;
        /**
         * Processes the current radioStateIconColor attribute value.
         */
