declare module TcHmi.Controls.Beckhoff {
    class TcHmiNumericInput extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __userInput: TcHmiNumericInput.UserInput | null;
        protected __storage: LocalStorage<{
            userInput: TcHmiNumericInput.UserInput;
        }> | undefined;
        /** Localization */
         ...
         */
        protected __evaluateDataPrecedence(incoming: number | null): boolean;
        /**
         ...
         */
        protected setZeroPadding(valueNew: number | null | undefined): void;
        /**
