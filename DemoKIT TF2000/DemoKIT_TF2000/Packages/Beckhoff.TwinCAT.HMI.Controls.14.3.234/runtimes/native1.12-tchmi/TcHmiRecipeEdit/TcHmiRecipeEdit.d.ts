declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiRecipeEdit extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __elementPathBox: HTMLDivElement | undefined;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiRecipeEditComponents {
    export class RecipeTypeParser {
         ...
         */
        constructor(__recipeManagementDomain: string | null, __parentControl?: (Controls.System.TcHmiControl | null) | undefined);
        /**
         * Parse a recipe type.
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiRecipeEditComponents {
    class RecipeEditor {
        ...
        protected __editorFactory: Helpers.EditorFactory;
        protected __editors: Map<string, Helpers.Editor<any, Helpers.Editor.EditorInfo> | RecipeReferenceEditor>;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiRecipeEditComponents {
    ...
    namespace RecipeReferenceEditor {
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiRecipeEditComponents {
    ...
    namespace SelectRecipeTypePrompt {
        interface LocalizableTexts extends Helpers.OkCancelPrompt.LocalizableTexts {
            headerText: Localizable;
        }
    }
