declare namespace TcHmi.Controls.Beckhoff {
     ...
     */
    class TcHmiCombobox<T extends any = any, D extends TcHmiCombobox.ListItemGeneric<T>[] | T[] | Dictionary<T> = TcHmiCombobox.ListItemGeneric<T>[] | T[] | Dictionary<T>> extends TcHmi.Controls.System.TcHmiControl {
        #private;
        ...
        protected __textInputDestroyers: DestroyFunction[];
        ...
        protected __enumDataSymbol: Symbol<T[]> | undefined | null;
        ...
        protected __enumDataSymbolExpressionResolved: SymbolExpression | undefined | null;
        protected __destroyEnumLocalizationWatch: DestroyFunction | null;
        /** Sanitised data for internal use */
        protected __data: TcHmiCombobox.ListItemGeneric<T>[];
        ...
        protected __destroyEnumDataSymbolWrite: DestroyFunction | null;
         ...
         */
        protected __onResolverForSrcDataWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<D>): void;
        /**
        ...
        /**
         */
        getEnumDataSymbol(): Symbol<T[]> | null | undefined;
        protected __processEnumDataSymbol(): void;
        protected __processEnumDataSymbolSchema(expression: SymbolExpression, expressionResolved?: SymbolExpression): void;
         ...
         * @param valueNew The new value for dataHeight.
         */
        setDropDownStyle(valueNew: TcHmiCombobox.DropDownStyle | keyof typeof TcHmiCombobox.DropDownStyle | null): void;
        /**
    ...
    namespace TcHmiCombobox {
        type ListItem<T extends null | string | number | boolean | object | undefined = any> = T extends null | string | number | boolean | object | undefined ? ListItemGeneric<T> : ListItemLegacy;
        interface ListItemLegacy {
            id?: number;
            text: string;
            value?: any;
            category?: string;
        }
        interface ListItemGeneric<T> extends ListItemLegacy {
            value: T;
        }
        function isListItem(obj: any): obj is TcHmiCombobox.ListItem;
        /**
         * 'Classic' | 'Mobile'
         */
        enum DropDownStyle {
