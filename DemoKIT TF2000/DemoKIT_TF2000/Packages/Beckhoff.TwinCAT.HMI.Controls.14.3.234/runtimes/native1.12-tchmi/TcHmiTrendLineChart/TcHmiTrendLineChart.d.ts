declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiTrendLineChart extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected static yAxisDefaultValueInternals: {
            readonly position: TcHmiTrendLineChart.Position;
            readonly logarithmicScale: boolean;
            readonly axisLabeling: TcHmiTrendLineChart.AxisLabeling;
        ...
        __startPresets: TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined;
        ...
        __endPresets: TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined;
        ...
        protected __yAxisInternal: TcHmiTrendLineChart.YAxisInternal[];
        ...
        __lineGraphDescriptionsOverride: TcHmiTrendLineChart.LineGraphDescription[] | null;
        ...
        protected __lineGraphDescriptionsInternal: TcHmiTrendLineChart.LineGraphDescriptionInternal[] | null;
        ...
        protected __gridLineStyle: keyof typeof TcHmiTrendLineChart.LineStyle | undefined;
        ...
        protected __subgridLineStyle: keyof typeof TcHmiTrendLineChart.LineStyle | undefined;
        ...
        protected __menuBarPosition: keyof typeof TcHmiTrendLineChart.MenuBarPosition | undefined;
        ...
        protected __referenceLines: TcHmiTrendLineChart.ReferenceLine[] | null | undefined;
        ...
        protected __manipulationInfo: {
            ...
            beginData: TcHmiTrendLineChart.Point[][];
            beginYAxis: TcHmiTrendLineChart.YAxisInternal[];
            actualXAxisStart: number | null;
            actualXAxisEnd: number | null;
            actualYAxis: TcHmiTrendLineChart.YAxisInternal[];
            mousePositionStart: {
                x: number;
                y: number;
            };
        ...
        __startDatatype: TcHmiTrendLineChart.Datatype | null;
        /** Internal end datatype */
        __endDatatype: TcHmiTrendLineChart.Datatype | null;
        ...
        __storage: LocalStorage<{
            ...
            lineGraphDescriptions: TcHmiTrendLineChart.LineGraphDescription[];
        }, {
            activeLegendElements: number;
        ...
        protected __menubar: undefined | TcHmiTrendLineChartHelper.Menubar;
        protected __statisticalDataDatagrid: undefined | TcHmiDatagrid;
        __virtualMappingForControlRecord: VirtualControlRightMapping[];
        /**  Internal reference lines, values can be adjusted */
        protected __internalReferenceLines: TcHmiTrendLineChart.ReferenceLine[] | null | undefined;
        ...
        protected __getDataCallback(result: Server.IResultObject): void;
         ...
         */
        setGridLineStyle(valueNew: keyof typeof TcHmiTrendLineChart.LineStyle | null): void;
         ...
         */
        setSubgridLineStyle(valueNew: keyof typeof TcHmiTrendLineChart.LineStyle | null): void;
         ...
         */
        setMenuBarPosition(valueNew: keyof typeof TcHmiTrendLineChart.MenuBarPosition | null): void;
         ...
         */
        setStartPresets(valueNew: TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined): void;
        /** The watch callback for the startPresets object resolver. */
        protected __onResolverForStartPresetsWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiTrendLineChart.TimeOrTimespanPreset[]>): void;
        /** Gets the value of startPresets */
        getStartPresets(): TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined;
         ...
         */
        setEndPresets(valueNew: TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined): void;
        /** The watch callback for the endPresets object resolver. */
        protected __onResolverForEndPresetsWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiTrendLineChart.TimeOrTimespanPreset[]>): void;
        /** Gets the value of endPresets */
        getEndPresets(): TcHmiTrendLineChart.TimeOrTimespanPreset[] | null | undefined;
         ...
         */
        setReferenceLines(valueNew: TcHmiTrendLineChart.ReferenceLine[] | null): void;
        /** The watch callback for the referenceLines object resolver. */
        protected __onResolverForReferenceLinesWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiTrendLineChart.ReferenceLine[]>): void;
        /** Returns the current value of the member variable referenceLines. */
        getReferenceLines(): TcHmiTrendLineChart.ReferenceLine[] | null | undefined;
         ...
         */
        setMouseMode(valueNew: TcHmiTrendLineChart.MouseMode | keyof typeof TcHmiTrendLineChart.MouseMode | null): void;
    ...
    namespace TcHmiTrendLineChart {
        interface YAxis {
            id: number;
            showAxis: boolean;
            position: TcHmiTrendLineChart.Position;
            logarithmicScale: boolean;
            axisLabeling: TcHmiTrendLineChart.AxisLabeling;
        ...
        /**
         * Compatibility alias
         * @deprected Use Position instead
         */
        type AxisPosition = Position;
        enum Position {
            Left = 0,
            Right = 1
        }
        ...
        interface TimeOrTimespanPreset {
            name: string;
            value: string;
        }
    }
}
declare namespace TcHmi.Controls.Beckhoff.TcHmiTrendHelpers {
    namespace TcHmiTrendHelper {
        /**
         * Check if the string is a Datetime
         */
        function isDatetime(date: string | null | undefined): date is string;
        /**
         * Check if the string is a keyWord (Latest, First)
         */
        function isKeyword(keyword: string | null): keyword is string;
        /**
         * Check if the string is a timespan
         */
        function isTimespan(timespan: string | null | undefined): timespan is string;
        /**
         * Convert milliseconds to iso 8601 string
         * @param milliSec Milliseconds
         */
        function __milliSecToIso(milliSec: number): string;
        /**
         * Convert iso 8601 string to milliseconds
         * @param t Iso 8601 string
         */
        function __isoToMilliSec(t: string): number;
    }
}
declare namespace TcHmi.Controls.Beckhoff.TcHmiTrendLineChartHelper {
    class Menubar {
        private localePrefix;
        /** Create the menubar div element with all controls */
        constructor(trendlineChart: TcHmiTrendLineChart);
        /** LineChart element to which the menu bar should be added. */
        protected __trendlineChart: TcHmiTrendLineChart;
        ...
        protected __menuBarControls: {
            ...
            showStatisticalData: TcHmiToggleButton;
        ...
        __onPressed(event: EventProvider.Event): void;
        /** Is called if activeChangedEvent of toggleButtons has raised. */
        __onIsActiveChanged(event: EventProvider.Event): void;
        /** Is called if activeChangedEvent of toggleButtons has raised. */
        __onValueChanged(event: EventProvider.Event): void;
         ...
         */
        __getTimeComboboxHandler(combobox: TcHmiCombobox<string>, action: (value: string | null) => void): (event: EventProvider.Event) => void;
