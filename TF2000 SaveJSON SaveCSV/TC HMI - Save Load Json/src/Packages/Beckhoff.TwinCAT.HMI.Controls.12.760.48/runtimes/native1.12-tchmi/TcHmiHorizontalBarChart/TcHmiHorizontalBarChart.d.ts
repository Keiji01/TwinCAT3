declare module TcHmi.Controls.Beckhoff {
    class TcHmiHorizontalBarChart extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __xPosition: string | undefined;
        ...
        protected __yAxisLabeling: string | undefined;
         ...
         * Possible Values: Left, Right
         */
        setXPosition(valueNew: string | null): void;
        /**
         * Gets the value of xPosition
         * @returns The current value of xPosition
         */
        getXPosition(): string | undefined;
        /**
         * Processes yPosition
         */
         ...
         */
        setYAxisLabeling(valueNew: string | null): void;
        /**
         * Gets the value of yAxisLabeling
         * @returns The current value of yAxisLabeling
         */
        getYAxisLabeling(): string | undefined;
        /**
         ...
         */
        getYAxisNameFontWeight(): "Normal" | "Bold" | "Auto" | undefined;
        /**
         ...
         */
        setSubgridLineStyle(valueNew: TcHmiHorizontalBarChart.LineStyle | null): void;
        /**
    ...
    module TcHmiHorizontalBarChart {
