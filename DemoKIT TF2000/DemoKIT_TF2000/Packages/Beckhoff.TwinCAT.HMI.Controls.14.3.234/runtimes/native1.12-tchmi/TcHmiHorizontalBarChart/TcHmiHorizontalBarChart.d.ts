declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiHorizontalBarChart extends TcHmi.Controls.System.TcHmiControl {
        #private;
        ...
        protected __xPosition: keyof typeof TcHmiHorizontalBarChart.Position | undefined;
        ...
        protected __barGraphDescriptions: TcHmiHorizontalBarChart.barGraphDescription[] | null | undefined;
        ...
        protected __barGraphDescriptionsInternal: TcHmiHorizontalBarChart.BarGraphDescriptionInternal[] | null | undefined;
        /** Only barGraphColors that have been selected from __barGraphDescriptionsInternal as an array of TcHmi.SolidColor or null */
        protected __barGraphDescriptionsSelected: TcHmiHorizontalBarChart.BarGraphDescriptionInternal[] | null | undefined;
        ...
        protected __referenceLines: TcHmiHorizontalBarChart.ReferenceLine[] | null | undefined;
        ...
        protected __gridLineStyle: keyof typeof TcHmiHorizontalBarChart.LineStyle | undefined;
        ...
        protected __subgridLineStyle: keyof typeof TcHmiHorizontalBarChart.LineStyle | undefined;
         ...
         */
        protected __createInternalColorArray(): TcHmiHorizontalBarChart.BarGraphDescriptionInternal[];
        /**
         ...
         */
        setBarGraphDescriptions(valueNew: TcHmiHorizontalBarChart.barGraphDescription[] | null): void;
        /**
         * The watch callback for the barGraphDescriptions object resolver.
         */
        protected __onResolverForBarGraphDescriptionsWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiHorizontalBarChart.barGraphDescription[]>): void;
        /**
         * Returns the current value of the member variable barGraphDescriptions.
         */
        getBarGraphDescriptions(): TcHmiHorizontalBarChart.barGraphDescription[] | null | undefined;
        /**
         ...
         */
        setReferenceLines(valueNew: TcHmiHorizontalBarChart.ReferenceLine[] | null): void;
        /**
         * The watch callback for the referenceLines object resolver.
         */
        protected __onResolverForReferenceLinesWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiHorizontalBarChart.ReferenceLine[]>): void;
        /**
         * Returns the current value of the member variable referenceLines.
         */
        getReferenceLines(): TcHmiHorizontalBarChart.ReferenceLine[] | null | undefined;
        /**
         ...
         * Possible Values: Left, Right
         */
        setXPosition(valueNew: keyof typeof TcHmiHorizontalBarChart.Position | null): void;
        /**
         ...
         */
        setSubgridLineStyle(valueNew: keyof typeof TcHmiHorizontalBarChart.LineStyle | null): void;
        /**
...
//# sourceMappingURL=TcHmiHorizontalBarChart.d.ts.map